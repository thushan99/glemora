...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    // Calculate totals
    const itemSubtotal = savedCart.reduce((sum, item) => sum + (item.price * item.quantity), 0);
  ...
  const handlePlaceOrder = () => {
    // For a real app, send order to your backend
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded">
                    {cartItems.map((item, index) => (
                      <div key={index} className={`flex justify-between ${index !== cartItems.length - 1 ? 'border-b pb-2 mb-2' : ''}`}>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mb-4">
                ...
                <div className="max-h-64 overflow-y-auto">
                  {cartItems.map((item, index) => (
                    <div key={index} className={`flex justify-between items-center ${index !== cartItems.length - 1 ? 'border-b pb-2 mb-2' : ''}`}>
                      <div className="flex items-center">
